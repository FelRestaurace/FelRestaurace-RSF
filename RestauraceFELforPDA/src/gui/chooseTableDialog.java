 ...
 *
 * Created on 30.11.2009, 14:05:14
 */
...
public class chooseTableDialog extends AbstractDialog {
    ...
    public chooseTableDialog(javax.swing.JFrame parent, boolean modal, AddAccountDialog caller, int mode) throws FileNotFoundException, NotBoundException, RemoteException {
        super(parent, modal);
        this.addCaller = caller;
        this.mode = mode;
        initComponents();
        jLabel1.setText("Vyberte stul :");
        okButton.setText("Vybrat");
        refresh();
    }

    public chooseTableDialog(javax.swing.JFrame parent, boolean modal, EditAccountDialog caller, int mode) throws FileNotFoundException, NotBoundException, RemoteException {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        add(tableBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 170, -1));
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if (mode == 1) addCaller.fillTable(table);
        else editCaller.fillTable(table);
        this.dispose();
    ...
    protected void refresh() throws FileNotFoundException, NotBoundException, RemoteException {
        ...
        setComboBoxModel(tables, tableBox);
    }
