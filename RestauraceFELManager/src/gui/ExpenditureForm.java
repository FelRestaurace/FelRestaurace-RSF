...
public class ExpenditureForm extends AbstractForm {
    ...
    protected int isValidInput() {
        ...
        if (Validator.isValidDate(jTextFieldDate.getText()) == null) return 3;
        if (!Validator.isSelectedItem(jComboBoxUser)) return 4;
        return 0;
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jButtonDelete, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 137, Short.MAX_VALUE)
                            ...
                            .addComponent(jButtonClear, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 137, Short.MAX_VALUE))
                        .addGap(5, 5, 5)))
                .addContainerGap())
        );
