...
public class UserRoleDialog extends javax.swing.JDialog {
     ...
     */
    public UserRoleDialog(JFrame parent, boolean modal, int userId) throws RemoteException, NotBoundException, FileNotFoundException {
        super(parent, modal);
     ...
     * @throws java.io.FileNotFoundException
     */
    private void setPerson() throws RemoteException, NotBoundException, FileNotFoundException {
        User user = null;        
    ...
    /**
     * Metoda nacitajici do promenne "currentRoles" dosavadni uzivatelske role
     * daneho uzivatele.
     *
     * @throws java.rmi.RemoteException
     * @throws java.rmi.NotBoundException
     * @throws java.io.FileNotFoundException
     */
    private void readCurrentUserRoles() throws RemoteException, NotBoundException, FileNotFoundException {
        currentRoles = ServiceFacade.getInstance().getUserRoles(userId);
    }
    ...
    /**
     * Metoda nastavujici nove uzivatelske role dle zaskrtnutych checkBoxu.
     *
     * @throws java.rmi.RemoteException
     * @throws java.rmi.NotBoundException
     * @throws java.io.FileNotFoundException
