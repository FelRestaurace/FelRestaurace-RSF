...
public class ResultTableModel extends AbstractTableModel {
    ...
    "Aktuální množství", "Druh suroviny", "Jednotka", "Čárový kód", "Minimální množství"};

    public static String [] namesAccount = {"ID", "Název", "Stůl", "Osoba", "Typ slevy", "Stav"};
    public static String [] namesUser = {"ID", "Křestní jméno", "Příjmení", "Role", "PIN", "Uživatelské jméno", "Vlastní heslo", "Kredit"};
    ...
    public static String [] namesBill={"Počet","Název","cena"};
